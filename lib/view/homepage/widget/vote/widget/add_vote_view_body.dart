...
import 'package:gatherly/view/homepage/widget/vote/widget/option_list.dart';
import 'package:gatherly/view/homepage/widget/vote/widget/title_text_vote.dart';
...
class AddVoteViewBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AddVoteControllerImp>(builder: (controller) {
              ...
              children: [
                ...
                Center(
                    child: Container(
                        ...
                        child: AppButton(
                            name: "add vote", onPressed: controller.addTask))),
              ],
            ),
          ),
        ),
